-- =============================================================================
-- Database Functions: Household Management Pages
-- =============================================================================
-- This file defines the PostgreSQL functions required for atomic household
-- creation operations. These functions ensure data consistency and provide
...
BEGIN
  ...
  SELECT id INTO head_relationship_id
